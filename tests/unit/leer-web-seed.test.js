...
/**
 * leer-web-seed — el skill genérico que enseña a conducir crawl4rs por el bus.
 *
 ...
 *
 * Ejecutar: node tests/unit/leer-web-seed.test.js
 */
...
(async () => {
  ...
  console.log('\n✓ leer-web: descubrimiento + canal + lectura del error verificados');
})();
