...
function checkContratoSinValidator(findings) {
  ...
  const EXCLUDED = new Set(['modulo-completo','manifest-completo','eventos-emitidos','companero-viaje','extensibilidad-modular','modulos-blueprint-driven','manual-audit-module-y-helpers','manual-mqtt-conexion-directa','manual-audit-bus-capture']);
