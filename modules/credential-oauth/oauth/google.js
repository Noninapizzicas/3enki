 ...
 *
 * Copia fiel del helper del monolito (credential-manager/oauth/google.js),
 * traída a credential-oauth en la Sesión 3 de la descomposición para que el
 * módulo sea autónomo (sin acoplar por ruta a credential-manager).
 */
