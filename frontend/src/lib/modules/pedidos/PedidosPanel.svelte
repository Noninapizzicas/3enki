<script lang="ts">
  ...
  import blueprint from './pedidos.blueprint.json';
...
<div class="jefe-pedidos" data-pedidos-panel={panelId}>
  ...
  <BlueprintForm {blueprint} moduleId="pedidos" titulo="Pedidos — Seguimiento" />
</div>

<style>
  .jefe-pedidos { display: flex; flex-direction: column; gap: 0; }
  .actor-badge {
