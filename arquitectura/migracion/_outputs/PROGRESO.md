...
_Última regeneración: 2026-05-08T01:19:32Z_
...
- **Migrados**: 31 / 73 (42%)
- **Drifts cerrados**: 705 / 2500 (28%)
- **Drifts restantes en baseline**: 1795
...
| 16 | core | `conversacion__memory-rag` | 438 | 2 → 0 (-100%) | _n/a_ |
| 17 | infra | `filesystem` | 1075 | 175 → 52 (-70%) | `bb98306` 2026-05-06 |
| 18 | infra | `certificate-authority` | 409 | 67 → 24 (-64%) | `bc7b712` 2026-04-20 |
| 19 | infra | `firmware-manager` | 1084 | 59 → 23 (-61%) | `7e2eb66` 2026-05-06 |
| 20 | infra | `esp32-dev` | 767 | 41 → 20 (-51%) | `bfa6e6d` 2026-05-06 |
| 22 | infra | `device-health` | 556 | 27 → 12 (-56%) | `0fc5e8d` 2026-05-07 |
| 23 | infra | `device-shadow` | 491 | 26 → 7 (-73%) | `9ba470d` 2026-05-07 |
| 24 | infra | `firmware-builder` | 686 | 26 → 7 (-73%) | `d88eae5` 2026-05-07 |
...
| 49 | dominio | `facturas` | 661 | 22 → 10 (-55%) | `e6c436d` 2026-05-07 |
| 53 | dominio | `staff-manager` | 494 | 18 → 2 (-89%) | `10739b7` 2026-05-07 |
| 56 | dominio | `pizzepos__carta-impresion` | 382 | 16 → 8 (-50%) | `2e572eb` 2026-05-07 |
| 59 | dominio | `pizzepos__carta-design` | 545 | 12 → 2 (-83%) | `56a566a` 2026-05-07 |
...
## Próximos en la cola (top 10 de 42 pendientes)
...
| 31 | infra | `pdf-viewer` | 634 | 50 | 2 | drifts 35/50 (70%) — esperado <50% |
| 32 | infra | `telegram-service` | 573 | 27 | 2 | drifts 26/27 (96%) — esperado <50% |
| 33 | dominio | `esp32-flasher` | 1138 | 149 | 0 | drifts 116/149 (78%) — esperado <50% |
| 34 | dominio | `log-manager` | 598 | 82 | 0 | sin tests/unit/ |
| 35 | dominio | `pizzepos__pedidos` | 918 | 72 | 0 | sin tests/unit/ |

<details><summary>Resto de pendientes (32 módulos)</summary>

| # | Capa | Slug | LOC | Drifts | Deps |
|---|------|------|-----|--------|------|
| 36 | dominio | `viabilidad` | 651 | 63 | 0 |
| 37 | dominio | `notas` | 485 | 59 | 0 |
| 38 | dominio | `pizzepos__productos` | 1220 | 55 | 0 |
| 39 | dominio | `pizzepos__carta-scheduler` | 560 | 47 | 0 |
| 40 | dominio | `calling-generator` | 812 | 40 | 0 |
| 41 | dominio | `escandallo` | 1098 | 40 | 0 |
| 42 | dominio | `pizzepos__cocina` | 1206 | 33 | 0 |
| 43 | dominio | `facturacion__asesoria` | 520 | 32 | 0 |
| 44 | dominio | `perifericos` | 856 | 32 | 0 |
| 45 | dominio | `pizzepos__menu-generator` | 338 | 32 | 0 |
| 46 | dominio | `pizzepos__tarifas` | 309 | 31 | 0 |
| 47 | dominio | `pizzepos__carta-marketing` | 394 | 30 | 0 |
| 48 | dominio | `recetas` | 897 | 30 | 0 |
| 50 | dominio | `pizzepos__carta-digital` | 401 | 21 | 0 |
| 51 | dominio | `pizzepos__cuentas` | 1016 | 21 | 0 |
| 52 | dominio | `pizzepos__cobros` | 661 | 18 | 0 |
| 54 | dominio | `dashboard` | 361 | 17 | 0 |
| 55 | dominio | `pizzepos__variaciones` | 443 | 17 | 0 |
| 57 | dominio | `pizzepos__impresion` | 1075 | 13 | 0 |
| 58 | dominio | `pizzepos__persistencia-comandero` | 1366 | 13 | 0 |
| 60 | dominio | `pizzepos__comandero` | 792 | 9 | 0 |
| 61 | dominio | `pizzepos__categorias` | 451 | 6 | 0 |
| 62 | dominio | `pizzepos__ingredientes` | 690 | 6 | 0 |
| 63 | dominio | `pizzepos__cuentas-canales` | 368 | 4 | 0 |
| 64 | dominio | `pizzepos__carta-manager` | 829 | 2 | 0 |
