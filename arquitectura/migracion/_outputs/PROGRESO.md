...
_Última regeneración: 2026-05-06T23:59:17Z_
...
- **Migrados**: 20 / 73 (27%)
- **Drifts cerrados**: 552 / 3557 (16%)
- **Drifts restantes en baseline**: 3005
...
| 24 | infra | `esp32-dev` | 767 | 41 → 20 (-51%) | `bc7b712` 2026-04-20 |
...
## Próximos en la cola (top 10 de 53 pendientes)
...
| 20 | infra | `device-shadow` | 478 | 53 | 0 | sin tests/unit/ |
| 21 | infra | `code-executor` | 618 | 52 | 0 | sin tests/unit/ |
| 22 | infra | `firmware-builder` | 526 | 50 | 0 | sin tests/unit/ |
| 23 | infra | `device-registry` | 702 | 43 | 0 | sin tests/unit/ |
...
<details><summary>Resto de pendientes (43 módulos)</summary>
