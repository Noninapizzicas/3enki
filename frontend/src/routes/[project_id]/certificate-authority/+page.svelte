<script lang="ts">
  /**
   * Pagina Certificate Authority (scoped a proyecto)
   *
   * URL: /[project_id]/certificate-authority
   *
   * LazyShell con chat + work-bar + panel flotante.
   * El panel permite gestionar certificados (emitir, revocar, renovar, listar).
   * El chat permite operar via lenguaje natural.
   */
