<script lang="ts">
  ...
  import blueprint from './variaciones.blueprint.json';
...
<div class="jefe-variaciones" data-variaciones-panel={panelId}>
  <div class="actor-badge">
    ...
    <span class="badge-scope">consulta + supervision</span>
  </div>
  <BlueprintForm {blueprint} moduleId="variaciones" titulo="Variaciones — Reglas por producto" />
</div>

<style>
  .jefe-variaciones { display: flex; flex-direction: column; gap: 0; }
  .actor-badge {
    display: flex; align-items: center; gap: 0.4rem;
    padding: 0.3rem 0.7rem; margin-bottom: 0.25rem;
    font-size: 0.7rem;
