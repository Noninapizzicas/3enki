...
id: cupulas/estados
dominio: cupulas
resumen: El rail vivo: listas ordenadas con freno entre pasos, plantillas de proceso por arquetipo, el juez del rail (objetivo + blocker tipado), el tiro automático, el fix del veredicto STALE y el RAIL-PROTOCOLO (pasos con forma ejecutable tool/input/verifica).
fuentes:
  - modules/estados/**
